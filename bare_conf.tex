...
% corr start
This paper is structured as follows. We start our presentation with Section~\ref{sec:method}, which describes the methodological foundations of this research. Section~\ref{sec:results} detalizes the architecture of the aforementioned system. Finally, Section~\ref{sec:discussion} summarizes and discusses the results of conducted analysis.
% corr end
...
\bibitem{Bourne} Bourne RRA, Flaxman SR, Braithwaite T, Cicinelli MV, Das A, Jonas JB, et al.; Vision Loss Expert Group. Magnitude, temporal trends, and projections of the global prevalence of blindness and distance and near vision impairment: a systematic review and meta-analysis. Lancet Glob Health. Vol. 5(9):e888-97, 2017.
