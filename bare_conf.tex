...
User-centered design sessions with visually impaired persons and analysis of aforementioned data sources provided substantial input for the design of the proposed system (Fig.~\ref{fig:schematics}). The process made it clear that understanding of the user needs was limited in the project team. Based on the results of the user-centered design process and conducted publication and patent analysis, we present the outline of the system for impaired human vision compensation. 
