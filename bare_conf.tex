...
Povilas Daniu\v{s}is & Andrius Budrionis \\
{\scriptsize Department of Business Technologies  and Entrepreneurship }& {\scriptsize Norwegian Centre for E-health Research}\\ 
{\scriptsize Vilnius Gediminas Technical University} & {\scriptsize University Hospital of North Norway}\\
{\scriptsize Vilnius, Lithuania} & {\scriptsize Troms\o, Norway}\\
{\scriptsize email: povilas.daniusis@vgtu.lt} & {\scriptsize email: andrius.budrionis@vgtu.lt} \\
& \\
Audrius Indriulionis & Darius Plikynas \\
{\scriptsize Department of Business Technologies and Entrepreneurship} & {\scriptsize Department of Business Technologies and Entrepreneurship}\\ 
...
{\scriptsize email: audrius.indriulionis@vgtu.lt} & {\scriptsize email: darius.plikynas@vgtu.lt} \\
\end{tabular}
} 
