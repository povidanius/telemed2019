...
Povilas Daniu\v{s}is & Audrius Indriulionis \\
{\scriptsize Department of Business Technologies  and Entrepreneurship }& {\scriptsize Department of  of Business Technologies and Entrepreneurship}\\ 
{\scriptsize Vilnius Gediminas Technical University} & {\scriptsize Vilnius Gediminas Technical University}\\
{\scriptsize Vilnius, Lithuania} & {\scriptsize Vilnius, Lithuania}\\
{\scriptsize email: povilas.daniusis@vgtu.lt} & {\scriptsize email: audrius.indriulionis@vgtu.lt} \\
& \\
Andrius Budrionis & Darius Plikynas \\
{\scriptsize Norwegian Centre for E-health Research} & {\scriptsize Department of Business Technologies and Entrepreneurship}\\ 
{\scriptsize University Hospital of North Norway} & {\scriptsize Vilnius Gediminas Technical University}\\
{\scriptsize Troms\o, Norway} & {\scriptsize Vilnius, Lithuania}\\
{\scriptsize email: andrius.budrionis@vgtu.lt} & {\scriptsize email: darius.plikynas@vgtu.lt} \\
\end{tabular}
} 
